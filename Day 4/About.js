  ...
  return (
    <div className="about-container">
      <div className="about-content">
        <h2>About Us</h2>
        <p>
          Welcome to Job4All! We are dedicated to connecting job seekers with
        ...
        <p>
          At Job4All, we believe that by upholding these values, we can
          facilitate meaningful connections between job seekers and employers,
          leading to successful and fulfilling careers.
        </p>
        <p>
          Contact us at <a href="mailto:info@job4all.com">info@job4all.com</a> for
